...
function display() {
    ...
    if(!mousepresent){
        ...
        if(pixelsToMeters(mousex) >= posx){
            accelerationx = fmousex;
        }
        else {
            accelerationx = -fmousex;
        }

        if(pixelsToMeters(mousey) >= posy){
            accelerationy = fmousey;
        }
        else {
            accelerationy = -fmousey;
        }
...
function reset(){
    ...
    fmousex = 5;
    document.getElementById("mousex").value = 5
    fmousey = 5;
    document.getElementById("mousey").value = 5
    speedy = 0;
    speedx = 0;
